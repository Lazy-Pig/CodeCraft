...
class TestPassCross(unittest.TestCase):
    ...
    def test_case6(self):
        ...
        truely_states = [
            {
                1: {'positive': [[(900, 10), (901, 9)], [(800, 10), (801, 9)], [(700, 10), (701, 9)]]},
                2: {'positive': [[], [], []]},
            ...
            {
                1: {'positive': [[], [], []]},
                2: {'positive': [[(100, 5), (200, 4), (300, 3), (101, 2), (201, 1)], [(301, 4), (900, 3), (800, 2), (700, 1)], [(901, 4), (801, 3), (701, 2), (400, 1)]]},
                3: {'positive': [[(401, 10)], [(500, 10), (501, 9)], [(600, 10), (601, 9)]]},
                4: {'positive': [[], [], []]}
            },
            {
                1: {'positive': [[], [], []]},
                2: {'positive': [[(100, 10), (200, 9), (300, 8), (101, 7), (201, 6), (401, 5), (500, 4), (600, 3), (501, 2), (601, 1)], [(301, 9), (900, 8), (800, 7), (700, 6)], [(901, 9), (801, 8), (701, 7), (400, 6)]]},
                3: {'positive': [[], [], []]},
                4: {'positive': [[], [], []]}
            }
        ]
